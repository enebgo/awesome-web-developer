...
const config = {
  ...
  url: 'https://enebgo.github.io',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/awesome-web-developer/',
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/enebgo/awesome-web-developer',
        },
        blog: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/enebgo/awesome-web-developer',
            label: 'GitHub',
            position: 'right',
          },
        ],
